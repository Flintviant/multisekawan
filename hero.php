...
<div id="pc-section" class="p-0 d-none d-lg-block">	
	<div id="carousel-na" class="carousel slide" data-bs-ride="carousel">
        ...
        <button class="carousel-control-prev" type="button" data-bs-target="#carousel-na" data-bs-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
            <span class="visually-hidden">Previous</span>
        </button>
        <button class="carousel-control-next" type="button" data-bs-target="#carousel-na" data-bs-slide="next">
...
<div id="mobile-section" class="p-0 d-block d-lg-none"> 
    <div id="carousel-mobile" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner parent-container-img">
            ...
            <div class="carousel-item">
                    <div class="slide" style="background-image: url('assets/mobile/sampulpotrait2.jpg');">
                    </div>
            </div>
        </div>
